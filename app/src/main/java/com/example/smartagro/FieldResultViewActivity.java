...
public class FieldResultViewActivity extends AppCompatActivity implements View.OnClickListener
{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_field_result_view);
        findViewById(R.id.imgbtnFrSearch).setOnClickListener(this);
        //findViewById(R.id.txtFarmerFrSearch).setOnClickListener(this);

       // lstFarmerFielresult=findViewById(R.id.lstFarmerFielresult);*/
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.imgbtnFrSearch:

                LoadResult _LoadResult=new  LoadResult();
                _LoadResult.execute();
                break;
            //case R.id.txtFarmerFrSearch:
    ...
    public void showResult(ArrayList<SoilResult> _SoilResult)
    {
        ...
        ListView listView = (ListView) findViewById(R.id.lstFarmerFielresult);
    ...
    public class LoadResult extends AsyncTask<Void,Void,ArrayList<SoilResult>>
    {
        ...
        protected void onPostExecute(ArrayList<SoilResult> soilResults) {
            ...
            FieldResultViewActivity.this.showResult(soilResults);
        }
